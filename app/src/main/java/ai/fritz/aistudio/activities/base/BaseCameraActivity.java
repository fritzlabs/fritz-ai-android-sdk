...
public abstract class BaseCameraActivity extends AppCompatActivity implements OnImageAvailableListener {
    ...
    private boolean hasPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int cameraPermission = checkSelfPermission(PERMISSION_CAMERA);
            int storagePermission = checkSelfPermission(PERMISSION_STORAGE);
                ...
                CameraConnectionFragment.newInstance(
                        new CameraConnectionFragment.ConnectionCallback() {
                            ...
                            public void onPreviewSizeChosen(final Size previewSize, final Size cameraViewSize) {
                                BaseCameraActivity.this.onPreviewSizeChosen(previewSize, cameraViewSize);
                            }
                        },
                        this,
                        getLayoutId(),
    ...
    protected abstract void onPreviewSizeChosen(final Size previewSize, final Size cameraViewSize);
