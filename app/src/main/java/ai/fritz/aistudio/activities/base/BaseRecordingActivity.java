...
public abstract class BaseRecordingActivity extends BaseCameraActivity implements OnImageAvailableListener {
    ...
    private ImageOrientation cameraOrientation;

    private AlertDialog imageSegDialog;
    ...
    @Override
    public void onPreviewSizeChosen(final Size previewSize, final Size cameraViewSize) {
        ...
        cameraOrientation = FritzVisionOrientation.getImageOrientationFromCamera(this, cameraId);

        // Dialog for image seg choice;
        if (imageSegDialog == null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.CustomDialog);
            builder.setTitle(R.string.available_models)
                    .setItems(getModelOptionsTextId(), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int selectedModelIndex) {
                            // The 'which' argument contains the index position
                            // of the selected item.
                            loadPredictor(selectedModelIndex);

                            chooseModelBtn.setText(getModelText(selectedModelIndex));
                        }
                    });
            // Create the AlertDialog object and return it
            imageSegDialog = builder.create();
        }
    ...
    public void onImageAvailable(final ImageReader reader) {
        ...
        final FritzVisionImage fritzImage = FritzVisionImage.fromMediaImage(image, cameraOrientation);
